...
Capsule_Shape3d_Constants :: enum {
}



capsule_shape3d_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

capsule_shape3d_name :: proc "contextless" () -> String_Name {
    return __class_name
}

new_capsule_shape3d :: proc "contextless" () -> Capsule_Shape3d {
    return cast(Capsule_Shape3d)__bindgen_gde.classdb_construct_object(capsule_shape3d_name_ref())
}

// methods

capsule_shape3d_set_radius :: proc "contextless" (
    self: Capsule_Shape3d,
    radius_: f32,
) {
    self := self
    radius_ := radius_
...
capsule_shape3d_get_radius :: proc "contextless" (
    self: Capsule_Shape3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
capsule_shape3d_set_height :: proc "contextless" (
    self: Capsule_Shape3d,
    height_: f32,
) {
    self := self
...
capsule_shape3d_get_height :: proc "contextless" (
    self: Capsule_Shape3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
capsule_shape3d_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("CapsuleShape3D", true)
    __name: String_Name
