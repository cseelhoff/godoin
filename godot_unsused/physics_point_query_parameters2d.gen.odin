...
physics_point_query_parameters2d_set_canvas_instance_id :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_canvas_instance_id_method_ptr, &self, raw_data(args), nil)
}
...
physics_point_query_parameters2d_get_canvas_instance_id :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_canvas_instance_id_method_ptr, &self, raw_data(args), &ret)
    return
}
...
physics_point_query_parameters2d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_canvas_instance_id", true)
    __set_canvas_instance_id_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1286410249)
    __name = new_string_name_cstring("get_canvas_instance_id", true)
    __get_canvas_instance_id_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
...
@(private = "file")
__set_canvas_instance_id_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_canvas_instance_id_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
