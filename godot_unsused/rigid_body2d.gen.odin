...
Rigid_Body2d_Freeze_Mode :: enum {
    Freeze_Mode_Static = 0,
    Freeze_Mode_Kinematic = 1,
}
Rigid_Body2d_Center_Of_Mass_Mode :: enum {
    Center_Of_Mass_Mode_Auto = 0,
    Center_Of_Mass_Mode_Custom = 1,
}
Rigid_Body2d_Damp_Mode :: enum {
    Damp_Mode_Combine = 0,
    Damp_Mode_Replace = 1,
}
Rigid_Body2dccd_Mode :: enum {
    Ccd_Mode_Disabled = 0,
    Ccd_Mode_Cast_Ray = 1,
...
rigid_body2d_set_continuous_collision_detection_mode :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_continuous_collision_detection_mode_method_ptr, &self, raw_data(args), nil)
}
...
rigid_body2d_get_continuous_collision_detection_mode :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_continuous_collision_detection_mode_method_ptr, &self, raw_data(args), &ret)
    return
}
...
rigid_body2d_init :: proc "contextless" () {
    ...
    ___integrate_forces_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 370287496)
    ...
    __get_inertia_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
    __name = new_string_name_cstring("set_inertia", true)
    __set_inertia_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    __name = new_string_name_cstring("set_center_of_mass_mode", true)
    __set_center_of_mass_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1757235706)
    __name = new_string_name_cstring("get_center_of_mass_mode", true)
    __get_center_of_mass_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3277132817)
    __name = new_string_name_cstring("set_center_of_mass", true)
    __set_center_of_mass_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 743155724)
    ...
    __set_linear_damp_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3406533708)
    __name = new_string_name_cstring("get_linear_damp_mode", true)
    __get_linear_damp_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2970511462)
    __name = new_string_name_cstring("set_angular_damp_mode", true)
    __set_angular_damp_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3406533708)
    __name = new_string_name_cstring("get_angular_damp_mode", true)
    __get_angular_damp_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2970511462)
    ...
    __name = new_string_name_cstring("set_continuous_collision_detection_mode", true)
    __set_continuous_collision_detection_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1000241384)
    __name = new_string_name_cstring("get_continuous_collision_detection_mode", true)
    __get_continuous_collision_detection_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 815214376)
    __name = new_string_name_cstring("set_axis_velocity", true)
    __set_axis_velocity_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 743155724)
    __name = new_string_name_cstring("apply_central_impulse", true)
    __apply_central_impulse_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3862383994)
    ...
    __apply_central_force_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 743155724)
    ...
    __add_constant_central_force_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 743155724)
    ...
    __set_freeze_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1705112154)
    __name = new_string_name_cstring("get_freeze_mode", true)
    __get_freeze_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2016872314)
...
@(private = "file")
__set_continuous_collision_detection_mode_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_continuous_collision_detection_mode_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
