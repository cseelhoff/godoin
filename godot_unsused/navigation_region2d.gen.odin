...
Navigation_Region2d_Constants :: enum {
}



navigation_region2d_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

navigation_region2d_name :: proc "contextless" () -> String_Name {
    return __class_name
}
...
navigation_region2d_get_rid :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: Rid) {
    self := self
...
navigation_region2d_set_navigation_polygon :: proc "contextless" (
    self: Navigation_Region2d,
...
navigation_region2d_get_navigation_polygon :: proc "contextless" (
    self: Navigation_Region2d,
...
navigation_region2d_set_enabled :: proc "contextless" (
    self: Navigation_Region2d,
    enabled_: Bool,
) {
    self := self
...
navigation_region2d_is_enabled :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_set_navigation_map :: proc "contextless" (
    self: Navigation_Region2d,
    navigation_map_: Rid,
) {
    self := self
...
navigation_region2d_get_navigation_map :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: Rid) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_set_use_edge_connections :: proc "contextless" (
    self: Navigation_Region2d,
    enabled_: Bool,
) {
    self := self
...
navigation_region2d_get_use_edge_connections :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_set_navigation_layers :: proc "contextless" (
    self: Navigation_Region2d,
...
navigation_region2d_get_navigation_layers :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: u32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_set_navigation_layer_value :: proc "contextless" (
    self: Navigation_Region2d,
    layer_number_: Int,
    value_: Bool,
) {
...
navigation_region2d_get_navigation_layer_value :: proc "contextless" (
    self: Navigation_Region2d,
    layer_number_: Int,
) -> (ret: Bool) {
    self := self
...
navigation_region2d_get_region_rid :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: Rid) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_set_enter_cost :: proc "contextless" (
    self: Navigation_Region2d,
    enter_cost_: f32,
) {
    self := self
...
navigation_region2d_get_enter_cost :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_set_travel_cost :: proc "contextless" (
    self: Navigation_Region2d,
    travel_cost_: f32,
) {
    self := self
...
navigation_region2d_get_travel_cost :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_bake_navigation_polygon :: proc "contextless" (
    self: Navigation_Region2d,
    on_thread_: Bool,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__bake_navigation_polygon_method_ptr, &self, raw_data(args), nil)
}

navigation_region2d_is_baking :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_get_bounds :: proc "contextless" (
    self: Navigation_Region2d,
) -> (ret: Rect2) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_region2d_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("NavigationRegion2D", true)
    __name: String_Name
    ...
    __set_navigation_polygon_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1515040758)
    __name = new_string_name_cstring("get_navigation_polygon", true)
    __get_navigation_polygon_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1046532237)
    ...
    __name = new_string_name_cstring("bake_navigation_polygon", true)
    __bake_navigation_polygon_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3216645846)
...
@(private = "file")
__bake_navigation_polygon_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
