...
A_Star2d_Constants :: enum {
}



a_star2d_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

a_star2d_name :: proc "contextless" () -> String_Name {
    return __class_name
}

new_a_star2d :: proc "contextless" () -> A_Star2d {
    return cast(A_Star2d)__bindgen_gde.classdb_construct_object(a_star2d_name_ref())
}

// methods

a_star2d__estimate_cost :: proc "contextless" (
    self: A_Star2d,
    from_id_: Int,
    end_id_: Int,
) -> (ret: f32) {
...
a_star2d__compute_cost :: proc "contextless" (
    self: A_Star2d,
    from_id_: Int,
    to_id_: Int,
) -> (ret: f32) {
...
a_star2d_get_available_point_id :: proc "contextless" (
    self: A_Star2d,
) -> (ret: i64) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
a_star2d_add_point :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
    position_: Vector2,
    weight_scale_: f32,
...
a_star2d_get_point_position :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
) -> (ret: Vector2) {
    self := self
...
a_star2d_set_point_position :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
    position_: Vector2,
) {
...
a_star2d_get_point_weight_scale :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
) -> (ret: f32) {
    self := self
...
a_star2d_set_point_weight_scale :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
    weight_scale_: f32,
) {
...
a_star2d_remove_point :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
) {
    self := self
...
a_star2d_has_point :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
) -> (ret: Bool) {
    self := self
...
a_star2d_get_point_connections :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
...
a_star2d_get_point_ids :: proc "contextless" (
    self: A_Star2d,
) -> (ret: Packed_Int64_Array) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
a_star2d_set_point_disabled :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
    disabled_: Bool,
) {
...
a_star2d_is_point_disabled :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
) -> (ret: Bool) {
    self := self
...
a_star2d_connect_points :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
    to_id_: Int,
    bidirectional_: Bool,
...
a_star2d_disconnect_points :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
    to_id_: Int,
    bidirectional_: Bool,
...
a_star2d_are_points_connected :: proc "contextless" (
    self: A_Star2d,
    id_: Int,
    to_id_: Int,
    bidirectional_: Bool,
...
a_star2d_get_point_count :: proc "contextless" (
    self: A_Star2d,
) -> (ret: i64) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
a_star2d_get_point_capacity :: proc "contextless" (
    self: A_Star2d,
) -> (ret: i64) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
a_star2d_reserve_space :: proc "contextless" (
    self: A_Star2d,
    num_nodes_: Int,
) {
    self := self
...
a_star2d_clear :: proc "contextless" (
    self: A_Star2d,
) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
a_star2d_get_closest_point :: proc "contextless" (
    self: A_Star2d,
...
a_star2d_get_closest_position_in_segment :: proc "contextless" (
    self: A_Star2d,
    to_position_: Vector2,
) -> (ret: Vector2) {
    self := self
...
a_star2d_get_point_path :: proc "contextless" (
    self: A_Star2d,
    from_id_: Int,
    to_id_: Int,
...
a_star2d_get_id_path :: proc "contextless" (
    self: A_Star2d,
    from_id_: Int,
    to_id_: Int,
    allow_partial_path_: Bool,
...
a_star2d_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("AStar2D", true)
    __name: String_Name
    ...
    __add_point_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 4074201818)
    ...
    __get_closest_point_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2300324924)
    __name = new_string_name_cstring("get_closest_position_in_segment", true)
    __get_closest_position_in_segment_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2656412154)
    __name = new_string_name_cstring("get_point_path", true)
    __get_point_path_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3427490392)
