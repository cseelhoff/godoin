...
Visible_On_Screen_Enabler2d_Constants :: enum {
}
Visible_On_Screen_Enabler2d_Enable_Mode :: enum {
...
visible_on_screen_enabler2d_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

visible_on_screen_enabler2d_name :: proc "contextless" () -> String_Name {
    return __class_name
}
...
visible_on_screen_enabler2d_set_enable_mode :: proc "contextless" (
    self: Visible_On_Screen_Enabler2d,
    mode_: Visible_On_Screen_Enabler2d_Enable_Mode,
) {
    self := self
    mode_ := mode_
...
visible_on_screen_enabler2d_get_enable_mode :: proc "contextless" (
    self: Visible_On_Screen_Enabler2d,
) -> (ret: Visible_On_Screen_Enabler2d_Enable_Mode) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
visible_on_screen_enabler2d_set_enable_node_path :: proc "contextless" (
    self: Visible_On_Screen_Enabler2d,
    path_: Node_Path,
) {
    self := self
...
visible_on_screen_enabler2d_get_enable_node_path :: proc "contextless" (
    self: Visible_On_Screen_Enabler2d,
) -> (ret: Node_Path) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
visible_on_screen_enabler2d_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("VisibleOnScreenEnabler2D", true)
    __name: String_Name

    __name = new_string_name_cstring("set_enable_mode", true)
    __set_enable_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2961788752)
    __name = new_string_name_cstring("get_enable_mode", true)
    __get_enable_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2650445576)
