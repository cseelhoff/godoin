...
Visual_Shader_Node_Float_Op_Operator :: enum {
    Op_Add = 0,
    Op_Sub = 1,
    Op_Mul = 2,
    Op_Div = 3,
...
visual_shader_node_float_op_init :: proc "contextless" () {
    ...
    __set_operator_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2488468047)
    __name = new_string_name_cstring("get_operator", true)
    __get_operator_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1867979390)
}
