...
physics_test_motion_parameters2d_init :: proc "contextless" () {
    ...
    __get_from_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3814499831)
    __name = new_string_name_cstring("set_from", true)
    __set_from_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2761652528)
