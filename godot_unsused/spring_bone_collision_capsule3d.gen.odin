...
Spring_Bone_Collision_Capsule3d_Constants :: enum {
}



spring_bone_collision_capsule3d_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

spring_bone_collision_capsule3d_name :: proc "contextless" () -> String_Name {
    return __class_name
}

new_spring_bone_collision_capsule3d :: proc "contextless" () -> Spring_Bone_Collision_Capsule3d {
    return __bindgen_gde.classdb_construct_object(spring_bone_collision_capsule3d_name_ref())
}

// methods

spring_bone_collision_capsule3d_set_radius :: proc "contextless" (
    self: Spring_Bone_Collision_Capsule3d,
    radius_: f32,
) {
    self := self
    radius_ := radius_
...
spring_bone_collision_capsule3d_get_radius :: proc "contextless" (
    self: Spring_Bone_Collision_Capsule3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
spring_bone_collision_capsule3d_set_height :: proc "contextless" (
    self: Spring_Bone_Collision_Capsule3d,
    height_: f32,
) {
    self := self
...
spring_bone_collision_capsule3d_get_height :: proc "contextless" (
    self: Spring_Bone_Collision_Capsule3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
spring_bone_collision_capsule3d_set_inside :: proc "contextless" (
    self: Spring_Bone_Collision_Capsule3d,
    enabled_: Bool,
) {
    self := self
...
spring_bone_collision_capsule3d_is_inside :: proc "contextless" (
    self: Spring_Bone_Collision_Capsule3d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
spring_bone_collision_capsule3d_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("SpringBoneCollisionCapsule3D", true)
    __name: String_Name
