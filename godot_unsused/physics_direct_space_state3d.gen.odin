...
physics_direct_space_state3d_init :: proc "contextless" () {
    ...
    __intersect_point_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 975173756)
    __name = new_string_name_cstring("intersect_ray", true)
    __intersect_ray_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3957970750)
    __name = new_string_name_cstring("intersect_shape", true)
    __intersect_shape_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3762137681)
    __name = new_string_name_cstring("cast_motion", true)
    __cast_motion_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1778757334)
    __name = new_string_name_cstring("collide_shape", true)
    __collide_shape_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3762137681)
    __name = new_string_name_cstring("get_rest_info", true)
    __get_rest_info_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1376751592)
}
