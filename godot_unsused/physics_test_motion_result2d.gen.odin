...
Physics_Test_Motion_Result2d_Constants :: enum {
}



physics_test_motion_result2d_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

physics_test_motion_result2d_name :: proc "contextless" () -> String_Name {
    return __class_name
}

new_physics_test_motion_result2d :: proc "contextless" () -> Physics_Test_Motion_Result2d {
    return cast(Physics_Test_Motion_Result2d)__bindgen_gde.classdb_construct_object(physics_test_motion_result2d_name_ref())
}

// methods

physics_test_motion_result2d_get_travel :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: Vector2) {
    self := self
...
physics_test_motion_result2d_get_remainder :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: Vector2) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collision_point :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: Vector2) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collision_normal :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: Vector2) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collider_velocity :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: Vector2) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collider_id :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: u64) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collider_rid :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: Rid) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collider :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: Object) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collider_shape :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: i32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collision_local_shape :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: i32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collision_depth :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collision_safe_fraction :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_get_collision_unsafe_fraction :: proc "contextless" (
    self: Physics_Test_Motion_Result2d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_test_motion_result2d_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("PhysicsTestMotionResult2D", true)
    __name: String_Name
    ...
    __get_collision_point_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    __name = new_string_name_cstring("get_collision_normal", true)
    __get_collision_normal_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    ...
    __get_collision_local_shape_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    __name = new_string_name_cstring("get_collision_depth", true)
    __get_collision_depth_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
