...
Physics_Server3d_Manager_Constants :: enum {
}



physics_server3d_manager_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

physics_server3d_manager_name :: proc "contextless" () -> String_Name {
    return __class_name
}

new_physics_server3d_manager :: proc "contextless" () -> Physics_Server3d_Manager {
    return __bindgen_gde.classdb_construct_object(physics_server3d_manager_name_ref())
}

// methods

physics_server3d_manager_register_server :: proc "contextless" (
    self: Physics_Server3d_Manager,
    name_: String,
...
physics_server3d_manager_set_default_server :: proc "contextless" (
    self: Physics_Server3d_Manager,
    name_: String,
    priority_: Int,
) {
...
physics_server3d_manager_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("PhysicsServer3DManager", true)
    __name: String_Name
