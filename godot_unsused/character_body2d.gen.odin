...
Character_Body2d_Motion_Mode :: enum {
    Motion_Mode_Grounded = 0,
    Motion_Mode_Floating = 1,
}
Character_Body2d_Platform_On_Leave :: enum {
...
character_body2d_init :: proc "contextless" () {
    ...
    __get_up_direction_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    __name = new_string_name_cstring("set_up_direction", true)
    __set_up_direction_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 743155724)
    __name = new_string_name_cstring("set_motion_mode", true)
    __set_motion_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1224392233)
    __name = new_string_name_cstring("get_motion_mode", true)
    __get_motion_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1160151236)
    __name = new_string_name_cstring("set_platform_on_leave", true)
    __set_platform_on_leave_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2423324375)
    __name = new_string_name_cstring("get_platform_on_leave", true)
    __get_platform_on_leave_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 4054324341)
    ...
    __get_floor_normal_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    __name = new_string_name_cstring("get_wall_normal", true)
    __get_wall_normal_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    __name = new_string_name_cstring("get_last_motion", true)
    __get_last_motion_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    __name = new_string_name_cstring("get_position_delta", true)
    __get_position_delta_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    __name = new_string_name_cstring("get_real_velocity", true)
    __get_real_velocity_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    __name = new_string_name_cstring("get_floor_angle", true)
    __get_floor_angle_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2841063350)
    __name = new_string_name_cstring("get_platform_velocity", true)
    __get_platform_velocity_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3341600327)
    ...
    __get_slide_collision_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 860659811)
    __name = new_string_name_cstring("get_last_slide_collision", true)
    __get_last_slide_collision_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2161834755)
}
