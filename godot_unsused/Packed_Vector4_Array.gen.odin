...
packed_vector4_array_packed_vector4_array_get :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    index_: Int,
) -> (ret: Vector4) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_get", true)
...
packed_vector4_array_packed_vector4_array_set :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    index_: Int,
    value_: Vector4,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_set", true)
...
packed_vector4_array_packed_vector4_array_size :: proc "contextless" (
    self: ^Packed_Vector4_Array,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_size", true)
...
packed_vector4_array_packed_vector4_array_is_empty :: proc "contextless" (
    self: ^Packed_Vector4_Array,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_is_empty", true)
...
packed_vector4_array_packed_vector4_array_push_back :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    value_: Vector4,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_push_back", true)
...
packed_vector4_array_packed_vector4_array_append :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    value_: Vector4,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_append", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector4_Array, &_gde_name, 3289167688)
    }
    value_ := value_
    args := []__bindgen_gde.TypePtr {
...
packed_vector4_array_packed_vector4_array_append_array :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    array_: Packed_Vector4_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_append_array", true)
...
packed_vector4_array_packed_vector4_array_remove_at :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    index_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_remove_at", true)
...
packed_vector4_array_packed_vector4_array_insert :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    at_index_: Int,
    value_: Vector4,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_insert", true)
...
packed_vector4_array_packed_vector4_array_fill :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    value_: Vector4,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_fill", true)
...
packed_vector4_array_packed_vector4_array_resize :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    new_size_: Int,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_resize", true)
...
packed_vector4_array_packed_vector4_array_clear :: proc "contextless" (
    self: ^Packed_Vector4_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_clear", true)
...
packed_vector4_array_packed_vector4_array_has :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    value_: Vector4,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_has", true)
...
packed_vector4_array_packed_vector4_array_reverse :: proc "contextless" (
    self: ^Packed_Vector4_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_reverse", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector4_Array, &_gde_name, 3218959716)
    }
    args := []__bindgen_gde.TypePtr {
    }
...
packed_vector4_array_packed_vector4_array_slice :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    begin_: Int,
    end_: Int,
) -> (ret: Packed_Vector4_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_slice", true)
...
packed_vector4_array_packed_vector4_array_to_byte_array :: proc "contextless" (
    self: ^Packed_Vector4_Array,
) -> (ret: Packed_Byte_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_to_byte_array", true)
...
packed_vector4_array_packed_vector4_array_sort :: proc "contextless" (
    self: ^Packed_Vector4_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_sort", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector4_Array, &_gde_name, 3218959716)
    }
    args := []__bindgen_gde.TypePtr {
    }
...
packed_vector4_array_packed_vector4_array_bsearch :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    value_: Vector4,
    before_: Bool,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_bsearch", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector4_Array, &_gde_name, 735671678)
    }
    value_ := value_
    before_ := before_
    args := []__bindgen_gde.TypePtr {
...
packed_vector4_array_packed_vector4_array_duplicate :: proc "contextless" (
    self: ^Packed_Vector4_Array,
) -> (ret: Packed_Vector4_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_duplicate", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector4_Array, &_gde_name, 3186305013)
    }
    args := []__bindgen_gde.TypePtr {
    }
    __ptr(self, raw_data(args), &ret, len(args))
...
packed_vector4_array_packed_vector4_array_find :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    value_: Vector4,
    from_: Int,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_find", true)
...
packed_vector4_array_packed_vector4_array_rfind :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    value_: Vector4,
    from_: Int,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_rfind", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector4_Array, &_gde_name, 3091171314)
    }
    value_ := value_
    from_ := from_
...
packed_vector4_array_packed_vector4_array_count :: proc "contextless" (
    self: ^Packed_Vector4_Array,
    value_: Vector4,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_vector4_array_count", true)
