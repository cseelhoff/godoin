...
new_navigation_agent2d :: proc "contextless" () -> Navigation_Agent2d {
    return __bindgen_gde.classdb_construct_object(navigation_agent2d_name_ref())
}
...
navigation_agent2d_set_debug_path_custom_line_width :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_debug_path_custom_line_width_method_ptr, &self, raw_data(args), nil)
}
...
navigation_agent2d_get_debug_path_custom_line_width :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_debug_path_custom_line_width_method_ptr, &self, raw_data(args), &ret)
    return
}
...
navigation_agent2d_init :: proc "contextless" () {
    ...
    __set_path_metadata_flags_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 24274129)
    __name = new_string_name_cstring("get_path_metadata_flags", true)
    __get_path_metadata_flags_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 488152976)
    ...
    __get_next_path_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1497962370)
    __name = new_string_name_cstring("set_velocity_forced", true)
    __set_velocity_forced_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 743155724)
    ...
    __get_velocity_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1497962370)
    ...
    __get_current_navigation_result_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 166799483)
    __name = new_string_name_cstring("get_current_navigation_path", true)
    __get_current_navigation_path_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2961356807)
    ...
    __get_final_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1497962370)
    ...
    __name = new_string_name_cstring("set_debug_path_custom_line_width", true)
    __set_debug_path_custom_line_width_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    __name = new_string_name_cstring("get_debug_path_custom_line_width", true)
    __get_debug_path_custom_line_width_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
}
...
@(private = "file")
__set_debug_path_custom_line_width_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_debug_path_custom_line_width_method_ptr: __bindgen_gde.MethodBindPtr