...
Navigation_Link3d_Constants :: enum {
}



navigation_link3d_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

navigation_link3d_name :: proc "contextless" () -> String_Name {
    return __class_name
}

new_navigation_link3d :: proc "contextless" () -> Navigation_Link3d {
    return __bindgen_gde.classdb_construct_object(navigation_link3d_name_ref())
}

// methods

navigation_link3d_get_rid :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: Rid) {
    self := self
...
navigation_link3d_set_enabled :: proc "contextless" (
    self: Navigation_Link3d,
    enabled_: Bool,
) {
    self := self
...
navigation_link3d_is_enabled :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_navigation_map :: proc "contextless" (
    self: Navigation_Link3d,
    navigation_map_: Rid,
) {
    self := self
...
navigation_link3d_get_navigation_map :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: Rid) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_bidirectional :: proc "contextless" (
    self: Navigation_Link3d,
    bidirectional_: Bool,
) {
    self := self
...
navigation_link3d_is_bidirectional :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_navigation_layers :: proc "contextless" (
    self: Navigation_Link3d,
...
navigation_link3d_get_navigation_layers :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: u32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_navigation_layer_value :: proc "contextless" (
    self: Navigation_Link3d,
    layer_number_: Int,
    value_: Bool,
) {
...
navigation_link3d_get_navigation_layer_value :: proc "contextless" (
    self: Navigation_Link3d,
    layer_number_: Int,
) -> (ret: Bool) {
    self := self
...
navigation_link3d_set_start_position :: proc "contextless" (
    self: Navigation_Link3d,
    position_: Vector3,
) {
    self := self
...
navigation_link3d_get_start_position :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: Vector3) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_end_position :: proc "contextless" (
    self: Navigation_Link3d,
    position_: Vector3,
) {
    self := self
...
navigation_link3d_get_end_position :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: Vector3) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_global_start_position :: proc "contextless" (
    self: Navigation_Link3d,
    position_: Vector3,
) {
    self := self
...
navigation_link3d_get_global_start_position :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: Vector3) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_global_end_position :: proc "contextless" (
    self: Navigation_Link3d,
    position_: Vector3,
) {
    self := self
...
navigation_link3d_get_global_end_position :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: Vector3) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_enter_cost :: proc "contextless" (
    self: Navigation_Link3d,
    enter_cost_: f32,
) {
    self := self
...
navigation_link3d_get_enter_cost :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_set_travel_cost :: proc "contextless" (
    self: Navigation_Link3d,
    travel_cost_: f32,
) {
    self := self
...
navigation_link3d_get_travel_cost :: proc "contextless" (
    self: Navigation_Link3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_link3d_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("NavigationLink3D", true)
    __name: String_Name
    ...
    __set_end_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3460891852)
    __name = new_string_name_cstring("get_end_position", true)
    __get_end_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3360562783)
    __name = new_string_name_cstring("set_global_start_position", true)
    __set_global_start_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3460891852)
    __name = new_string_name_cstring("get_global_start_position", true)
    __get_global_start_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3360562783)
    __name = new_string_name_cstring("set_global_end_position", true)
    __set_global_end_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3460891852)
    __name = new_string_name_cstring("get_global_end_position", true)
    __get_global_end_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3360562783)
