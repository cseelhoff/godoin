...
Navigation_Path_Query_Result3d_Path_Segment_Type :: enum {
...
navigation_path_query_result3d_init :: proc "contextless" () {
    ...
    __set_path_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 334873810)
    __name = new_string_name_cstring("get_path", true)
    __get_path_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 497664490)
