...
Ray_Cast2d_Constants :: enum {
}



ray_cast2d_name_ref :: proc "contextless" () -> ^String_Name {
    return &__class_name
}

ray_cast2d_name :: proc "contextless" () -> String_Name {
    return __class_name
}
...
ray_cast2d_set_enabled :: proc "contextless" (
    self: Ray_Cast2d,
    enabled_: Bool,
) {
    self := self
...
ray_cast2d_is_enabled :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_set_target_position :: proc "contextless" (
    self: Ray_Cast2d,
...
ray_cast2d_get_target_position :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Vector2) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_is_colliding :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_force_raycast_update :: proc "contextless" (
    self: Ray_Cast2d,
) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_get_collider :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Object) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_get_collider_rid :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Rid) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_get_collider_shape :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: i32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_get_collision_point :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Vector2) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_get_collision_normal :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Vector2) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_add_exception_rid :: proc "contextless" (
    self: Ray_Cast2d,
    rid_: Rid,
) {
    self := self
...
ray_cast2d_add_exception :: proc "contextless" (
    self: Ray_Cast2d,
...
ray_cast2d_remove_exception_rid :: proc "contextless" (
    self: Ray_Cast2d,
    rid_: Rid,
) {
    self := self
...
ray_cast2d_remove_exception :: proc "contextless" (
    self: Ray_Cast2d,
    node_: Collision_Object2d,
) {
    self := self
...
ray_cast2d_clear_exceptions :: proc "contextless" (
    self: Ray_Cast2d,
) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_set_collision_mask :: proc "contextless" (
    self: Ray_Cast2d,
    mask_: Int,
) {
    self := self
...
ray_cast2d_get_collision_mask :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: u32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_set_collision_mask_value :: proc "contextless" (
    self: Ray_Cast2d,
    layer_number_: Int,
    value_: Bool,
) {
...
ray_cast2d_get_collision_mask_value :: proc "contextless" (
    self: Ray_Cast2d,
    layer_number_: Int,
) -> (ret: Bool) {
    self := self
...
ray_cast2d_set_exclude_parent_body :: proc "contextless" (
    self: Ray_Cast2d,
    mask_: Bool,
) {
    self := self
...
ray_cast2d_get_exclude_parent_body :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_set_collide_with_areas :: proc "contextless" (
    self: Ray_Cast2d,
    enable_: Bool,
) {
    self := self
...
ray_cast2d_is_collide_with_areas_enabled :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_set_collide_with_bodies :: proc "contextless" (
    self: Ray_Cast2d,
    enable_: Bool,
) {
    self := self
...
ray_cast2d_is_collide_with_bodies_enabled :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_set_hit_from_inside :: proc "contextless" (
    self: Ray_Cast2d,
    enable_: Bool,
) {
    self := self
...
ray_cast2d_is_hit_from_inside_enabled :: proc "contextless" (
    self: Ray_Cast2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
ray_cast2d_init :: proc "contextless" () {
    __class_name = new_string_name_cstring("RayCast2D", true)
    __name: String_Name
